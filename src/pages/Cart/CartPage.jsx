        ...
        try {
            ...
            Object.entries(groupedItems).forEach(([source, items]) => {
                ...
                copies.forEach((copyLabel, copyIndex) => {
                    ...
                    doc.addImage(RedzSign64, 'PNG', leftX + 10, finalY - 3, 15, 15);
                    doc.text('(Tandatangan)', leftX, finalY + 15);
                    doc.text('Nama : Muhd Redzuan', leftX, finalY + 20);
                    doc.text('Jawatan : PF', leftX, finalY + 25);
                    doc.text(`Tarikh : ${new Date().toLocaleDateString('en-GB')}`, leftX, finalY + 30);
                    ...
                    doc.text(`Tarikh : ${new Date().toLocaleDateString('en-GB')}`, middleX, finalY + 30);


                    const rightX = pageWidth - 60;
                    doc.text('Penerima', rightX, finalY);
                    doc.addImage(RozzaSign64, 'PNG', rightX + 5, finalY + 3, 13, 7);
                    doc.text('(Tandatangan)', rightX, finalY + 15);
                    doc.text('Nama : Rozzalia', rightX, finalY + 20);
                    doc.text('Jawatan : PPF', rightX, finalY + 25);
                    doc.text(`Tarikh : ${new Date().toLocaleDateString('en-GB')}`, rightX, finalY + 30);
                });
